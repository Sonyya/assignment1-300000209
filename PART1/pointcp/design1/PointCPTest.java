...
public class PointCPTest
{
  ...
  public static void main(String[] args)
  {
    ...
    System.out.println("Cartesian-Polar Coordinates Conversion Program (DESIGN 1)");
    ...
    PointCP pointB = new PointCP('C',8,6);
    ...
    System.out.println("\nSoit A le point que vous venez d entrer et B le point cartesien\n" + pointB.toString());
    
    System.out.println("\ndistance AB = \n" + point.getDistance(pointB));
    
    PointCP img = point.rotatePoint(20);
    System.out.println("\n le point image de A apres une rotation de 20degres \n" + point.rotatePoint(20).toString());
    img.convertStorageToPolar();
