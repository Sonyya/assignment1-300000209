...
public static void main(String[] args)
{
 ...
 System.out.println("POLAR COORDINATES MANIPULATION PROGRAM (DESIGN 2)");
 ...
 PointCP2 pointB = new PointCP2(temp.getRho(),temp.getTheta());
...
private static PointCP2 getInput() throws IOException
{
 ...
 for (int i = 0; i < 2; i++)
 {
   while (!(isOK))
   {
     ...
     // Prompt the user
     //(i == 0) // First argument - type of coordinates
